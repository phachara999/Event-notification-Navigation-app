...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $imgPath = $existingImage; // Default to existing image
    ...
    $params = [$name, $start_time, $end_time, $detail, $room, $Bding, $mainOrg, $subOrg, $personnel, $imgPath, $event_id];
    ...
    if ($stmt->execute()) {
        ...
        $response = array('status' => 'error', 'message' => 'Server Error: ' . $stmt->error);
        http_response_code(500);
        echo json_encode($response);
    }
