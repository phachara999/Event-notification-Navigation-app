...
if ($_SERVER["REQUEST_METHOD"] === "GET") {
    if (isset($_GET['locationId'])) {
        ...
        $sql = "SELECT `rooms`.*, `location`.`name` AS location_name, `location`.`building_number` AS building_number FROM `rooms` LEFT JOIN `location` ON `rooms`.`location_id` = `location`.`id` ORDER BY `location`.`id` ASC;";
